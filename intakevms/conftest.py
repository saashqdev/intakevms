...
from intakevms.libs.testing.config import storage_settings
...
from intakevms.modules.virtual_machines.entrypoints.schemas import (
    QOS,
    RAM,
    Os,
    Cpu,
...
def unauthorized_client() -> Generator[TestClient, None, None]:
    ...
    # Removing mock authorization
    app.dependency_overrides = {}

    client = TestClient(app)
    yield client

    # Restoring mock authorization
