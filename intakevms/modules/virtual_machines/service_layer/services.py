...
from intakevms.libs.libvirt.vm import get_vms_state, get_vm_snapshots
...
if TYPE_CHECKING:
    from intakevms.modules.virtual_machines.adapters.orm import VirtualMachines
...
class VMServiceLayerManager(BackgroundTasks):
    ...
    def _transform_clone_vm_data(  # noqa: C901 # TODO: refactor using DTO
        ...
        except Exception as err:  # TODO: replace with specific exception
